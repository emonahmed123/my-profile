      ...
      <div className="portfolio-card p-[0.9rem]  md:p-[2rem] max-w-[375px] text-accent hover:text-white border  border-[#A740CD]">
        <div className="text-left  image-content">
          ...
          <div className="button-content flex text-white justify-between mt-5">
            <Link
              href={`/projects/${_id}`}
              className=" font-poppe gap-x-1 border border-purple-400   px-2 py-2 rounded-[5px] flex justify-center items-center  text-white  text-[10px] lg:text-[12px]"
            >
              <FaRegCircleDot />
              View Details
            </Link>
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="font-poppe gap-x-1  px-2 py-2 rounded-[5px] flex justify-center items-center  border border-purple-400  text-white  text-[10px] lg:text-[12px]"
            >
              <MdLiveTv />
              View Live
            </a>
